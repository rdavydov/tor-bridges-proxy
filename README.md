...
Абсолютно минималистичный образ Tor с SOCKS 5 proxy сервером и веб-интерфейсом с авторизацией для добавления мостов. Без функции выходного узла, только SOCKS 5 proxy и DNS over Tor. При первом запуске автоматически генерируется пароль для доступа в админ-панель.
